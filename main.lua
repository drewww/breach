...
local overlayDisplay = spectrum.Display(SCREEN_WIDTH * 4, SCREEN_HEIGHT * 2, microAtlas, prism.Vector2(8, 16))
...
function love.load()
   manager:push(spectrum.gamestates.TutorialState(display, overlayDisplay, "melee_pushpre"))
   manager:hook()
   spectrum.Input:hook()
end
