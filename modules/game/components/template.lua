...
--- @field projectiles? number If set, fire N projectiles spread across the template shape, each tracing its own line. Actors can be hit multiple times if multiple projectiles pass through them.
